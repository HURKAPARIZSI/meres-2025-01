...
$dbname = "dolgozatdb";       // Az adatbázis neve
...
// Ha a 'nap' paraméter van, dátum alapján keresünk
if (isset($_GET['nap'])) {
    $date = $_GET['nap'];

    // Ellenőrizzük, hogy a dátum tartalmazza-e a '-' karaktert 
...
// Ha a 'nev' paraméter van, név alapján keresünk
